...
namespace ProjectWebforms.Ahmad
{
    ...
    {
        private string filePath = HttpContext.Current.Server.MapPath("~/Ahmad/books.txt");
        private string filterFilePath = HttpContext.Current.Server.MapPath("filteredBook.txt");
        ...
        protected void gvBooks_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "EditBook") // تعديل الكتاب
            {
                ...
                {
                    Response.Redirect($"EditBooks.aspx?BookID={bookID}");
                }
                else
                {
