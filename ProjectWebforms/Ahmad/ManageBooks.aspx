<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageBooks.aspx.cs" Inherits="ProjectWebforms.Ahmad.ManageBooks" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="sidebar">
            <h2>Library Admin</h2>
            <asp:Button CssClass="menu-button active" runat="server" Text="Manage Books" PostBackUrl="~/ManageBooks.aspx" />
            ...
            <asp:Button CssClass="menu-button" runat="server" Text="Export Reports" PostBackUrl="~/ExportReports.aspx" />
            <asp:Button CssClass="menu-button" runat="server" Text="Logout" PostBackUrl="~/Logout.aspx" />
        </div>
