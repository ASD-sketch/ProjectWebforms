...
namespace ProjectWebforms.Ahmad
{
    ...
    {
        private string usersFilePath = HttpContext.Current.Server.MapPath("~/Sofyan/users.txt");
        private string manageUsersFilePath = HttpContext.Current.Server.MapPath("~/Ahmad/manageUsers.txt");
        private string blacklistFilePath = HttpContext.Current.Server.MapPath("~/Ahmad/blacklist.txt");
