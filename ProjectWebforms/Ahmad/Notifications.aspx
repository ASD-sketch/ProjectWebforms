<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="ProjectWebforms.Ahmad.Notifications" %>
            ...
            <asp:Repeater ID="rptNotifications" runat="server">
                <ItemTemplate>
                    <div class="notification-card">
                        <h5><%# Eval("UserName") %> (<%# Eval("UserEmail") %>)</h5>
                        ...
                        <div class="reply-section" id="replySection_<%# Eval("ID") %>">
                            ...
                            <br />
                            <asp:Button ID="btnSendReply" runat="server" CssClass="btn btn-success btn-sm bu" Text="Send Reply"
