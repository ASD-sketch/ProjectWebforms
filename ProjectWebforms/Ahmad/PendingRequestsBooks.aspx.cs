...
{
    public partial class PendingRequestsBooks : System.Web.UI.Page
    {
        private string pendingRequestsFile = HttpContext.Current.Server.MapPath("~/abdullah/PendingRequestsBooks.txt");
        private string approvedRequestsFile = HttpContext.Current.Server.MapPath("~/abdullah/ApprovedRequestsBooks.txt");
        private string booksFile = HttpContext.Current.Server.MapPath("~/Ahmad/books.txt");
        private string blacklistFile = HttpContext.Current.Server.MapPath("~/blacklist.txt");
        private string rejectedRequestsFile = HttpContext.Current.Server.MapPath("~/Ahmad/RejectedRequests.txt");
        private string invalidRequestsFile = HttpContext.Current.Server.MapPath("~/Ahmad/InvalidRequests.txt");
