...
namespace ProjectWebforms.abdullah
{
    public partial class PageBook : System.Web.UI.Page
    {
        string loggedInUserFile;

        protected void Page_Load(object sender, EventArgs e)
        {
            loggedInUserFile = Server.MapPath("~/Sofyan/loggedInUser.txt");
        ...
        {
            string filePath = Server.MapPath("~/Ahmad/books.txt");
        ...
        {
            string filePath = Server.MapPath("~/abdullah/ApprovedRequestsBooks.txt");
        ...
        protected void BooksRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Borrow")
            {
                ...
                string blackList = Server.MapPath("~/Ahmad/blacklist.txt");
        ...
        protected void btnSubmitBorrow_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Server.MapPath("~/abdullah/PendingRequestsBooks.txt");
